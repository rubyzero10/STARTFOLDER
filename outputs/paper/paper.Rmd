---
title: "Paper 1 (subject to change;marriage)"
author: 
  - Oluwabusayomi Adekuajo
thanks: "Code and data are available at: https://github.com/rubyzero10/STARTFOLDER"
date: "`r format(Sys.time(), '%d %B %Y')`"
abstract: "(past tense) First sentence(broad and insperational. Second sentence(specific of what I did). Third sentence(findings). Fourth sentence(why it maters)."
output:
...
# Introduction
First paragraph is motivational and broad, similar to first sentence of abstract with more substance

Second para is about what we done and found 

Third para is about implications 

The remainder of this paper is: Section ... ex section explains the data... section \@ref(result) covers reseults ...
...
Then show the data set (using kable code) ( Tbale (ref) )

Paragraph about 
We are interested in the relationship between x and y becuase z
Figure X shows the relationship between h
